...
<script type="text/javascript">
	...
	$(function () 
	{
		...
		var baseObj = getBaseGridOption("period_stat", "N", "Y", "N", "N");
		...
		obj.refresh = function (evt, ui) {
			...
			if(data != undefined && data.length > 0) 
			{
				for(var i=0, len=data.length; i<len; i++) 
				{
					...
					for(var ii=1, len2=12; ii <= len2; ii++)
					{
						sum["cnt"+ii] += d["cnt"+ii];
						sum["sum"+ii] += d["sum"+ii];
					}
	...
	function goStats(kind)
	{
		...
		{
			document.location = "period_quarter_stat.jsp";
		}
	}
		...
		<div class="panel-heading">
			<div class="panel-options">
				<ul class="nav nav-tabs">
					<li class="active"><a href="javascript:goStats('score')">월별</a></li>
					<li class=""><a href="javascript:goStats('item')">분기별</a></li>
				</ul>
			</div>
		</div>
	</div>
