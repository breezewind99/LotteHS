...
public class Finals 
{
	...
	//서버 URL
	public static String 			SERVER_URL = (!isDev) ? "http://192.168.0.31" : "http://192.168.0.41"; //운영 : 개발
	
	/* :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: 녹취 이력 설정 START ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::  */
	
	//미디어 서버 URL
	public static String 			MEDIA_SERVER_URL = (!isDev) ? "http://192.168.0.55:8888" : "http://192.168.0.55:8888"; //운영 : 개발
	
	/**
	 * HTTPS 일 경우 문제 발생
	 * 미디어 서버 URL 다운로드 
	 */
	public static String 			MEDIA_SERVER_URL_D = (!isDev) ? "http://192.168.0.55:8888" : "http://192.168.0.55:8888"; //운영 : 개발
