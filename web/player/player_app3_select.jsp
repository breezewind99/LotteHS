...
<%
	...
	try {
		...
		//
		String date = ucid.substring(0,8);
		...
		//argMap.put("_user_id",user_id);		

		// 연관 녹취이력 조회
		List<Map<String, Object>> list = db.selectList("rec_search.selectRelationList4", argMap);
		if(list.size()<1) {
...
<script type="text/javascript">
	...
	var fft_ext = "<%=fft_ext%>";
	var rec_datm = "<%=curdata.get("rec_datm").toString()%>";
