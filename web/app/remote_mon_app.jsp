...
<%
	...
	<%
		for(Map<String, Object> item : list) 
		{
			...
			//String rec_inout_nm = ("1".equals(ch_status)) ? (("I").equals(rec_inout) ? "IN" : "OUT") : "&nbsp;";
			String rec_inout_nm = ("1".equals(ch_status)) ? (("I").equals(rec_inout) ? "IN" : "OUT") : ("0".equals(ch_status)) ?  "WAIT" : "&nbsp;";
			...
			*/
			...
			out.print("		<span class=\"colLeft ext_with\">" + spart_name + "</span>\n");
	...
	<div class="grey_back2">
		<div class="colLeft"><span class="ext_squre01_1 colLeft"></span><span class="ext_text">장시간 대기</span></div>
		...
		<div class="colLeft"><span class="ext_text">장시간 콜 통화 : </span></div>
		<div class="colLeft"><span class="ext_squre02_3 colLeft"></span><span class="ext_text">인바운드</span></div>
		<div class="colLeft"><span class="ext_squre02_4 colLeft"></span><span class="ext_text">아웃바운드</span></div>
